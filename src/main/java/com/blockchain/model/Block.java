...
public class Block implements Serializable {
    ...
    /**
     * The currHash will contain the signature or, in other words, the encrypted
     * data from this block,which will be encrypted with the private key of the
     * miner that will get to mine this block. <br>
     * The current hash/signature of the block is just the encrypted version of the
     * data contained in the block.
     **/
    private byte[] currHash;
    /**
     * The timeStamp obviously will contain a timestamp of when this block was
     * mined/finalized.
     */
    private String timeStamp;
    /**
     * The field minedBy will contain the public key, which also doubles as the
     * public address of the miner that managed to mine this block. <br>
     * In the process of blockchain verification, this public address/public key
     * will be used to verify that the currHash/signature of this block is the same
     * as the hash of the data presented by this block and secondary that this block
     * was indeed mined by this particular miner. <br>
     * The miner’s public key is used for other peers to verify the block by
     * comparing the signature’s hash against the hash of the block’s data. <br>
     * The miner’s private key is used to encrypt the block’s data, which creates
     * the signature.
     */
    ...
    /**
     * used while the application is running and is used to create a completely new
     * block (in other words, the head of the blockchain) for us to work on.
     *
    ...
    /**
     * used once to create our first block. <br>
    ...
    /**
     * verifies a digital signature. verify the data in this class against the
     * signature stored in the currHash.
     *
     * @param signing
     * @return whether the data contained in this class is verified against its
     *         currHash.
    ...
    public Boolean isVerified(Signature signing)
        ...
        // Get publicKey from this.minedBy (which is the public key in byte array
        // format)
    ...
    /**
     * Note how all the essential fields that make certain the block is unique are
     * included in the toString() method.
     **/
    @Override
