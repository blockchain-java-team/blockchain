...
public class EnsaChain {
    public static void main(String[] args) throws Exception {
        ...
        // should work
        Thread.sleep(16000);
        Transaction t = new Transaction(WalletData.getInstance().getWallet(), walletA.getPublicKey().getEncoded(), 50,
                1, transSignature);
        ...
        // should not work
        Thread.sleep(16000);
        Transaction t2 = new Transaction(WalletData.getInstance().getWallet(),
                walletA.getPublicKey().getEncoded(), 100050, 1, transSignature);
